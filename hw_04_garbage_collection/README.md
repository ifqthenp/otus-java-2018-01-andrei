...
|-----------------|---------------|---------
| 1. Serial (DefNew) | Serial Mark Sweep Compact | -XX:+UseSerialGC
| 2. Parallel scavenge (PSYoungGen) | Serial Mark Sweep Compact (PSOldGen) | -XX:+UseParallelGC
| 3. Parallel scavenge (PSYoungGen) | Parallel Mark Sweep Compact (ParOldGen) | -XX:+UseParallelOldGC
| 4. Parallel (ParNew) | Serial Mark Sweep Compact | -XX:+UseParNewGC
| 5. Concurrent Mark Sweep | Serial (DefNew) | -XX:-UseParNewGC -XX:+UseConcMarkSweepGC 
| 6. Parallel (ParNew) | Concurrent Mark Sweep | -XX:+UseParNewGC -XX:+UseConcMarkSweepGC 
| 7. GarbageFirst (G1) | GarbageFirst (G1) | -XX:+UseG1GC 
